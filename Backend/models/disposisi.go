...
type Disposisi struct {
	...
	UnitID      uint      `gorm:"column:unit_id;not null;index" json:"unit_id"`
	...
	Unit      Unit      `gorm:"foreignKey:UnitID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;" json:"unit"`
}
